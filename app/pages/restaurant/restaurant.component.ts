...
//   fetchDishes(): void {
//     this.http.get(`http://localhost:3000/api/dishes?restaurantName=${this.restaurantName}&mailId=${this.mailId}`)
//       .subscribe({
//         next: (response: any) => {
//           this.dishes = response.dishes;
//         },
...
//   isValidDish(): boolean {
//     return (
//       this.newDish.dishName.length >= 3 &&
//       this.newDish.description.length >= 10 &&
//       this.newDish.price > 0 && this.newDish.price < 1000 &&
//       this.newDish.cuisine !== '' &&
//       this.newDish.type !== '' &&
